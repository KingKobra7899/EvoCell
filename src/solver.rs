    ...
    fn process_additions(&mut self) {
        for (child_pos, child_mass, brain_delta, child_brain_size, child_sight_r, child_sight_a, child_pred, child_max_speed,child_adhesion, child_thresh, parent_cell) in self.pending_additions.drain(..) {
            ...
            let child_cell = Cell {
                    ...
                    current_energy: parent_cell.max_mass,
                    ...
                    metabolic_rate: 0.0,
                    current_mass: parent_cell.current_mass * 0.25,
                    birth_threshold: clamp(child_thresh, 0.5, 0.85),
                    max_mass: parent_cell.max_mass,
                    max_speed: parent_cell.max_speed,
                    old_h: 0.0,
                    old_iso: 0.0,
                    old_soc: 0.0,
                    ...
                    sight_r: parent_cell.sight_r,
                    sight_a: child_sight_a,
                    desired_energy: parent_cell.desired_energy,
                    predation: clamp(parent_cell.predation, 0.0, 1.0),
                    to_delete: false,
                };
